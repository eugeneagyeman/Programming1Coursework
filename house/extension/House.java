...
public class House {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(toRun) {
            ...
            if (hours < 168) {
                ...
                hours = MAXIMUM_TIME;
                System.out.println("You cannot run the simulation for more than the the maximum time allowed (1 month) ");
    ...
    protected void save() {
        PrintStream ps = null;
        try {
            ps = new PrintStream(new FileOutputStream("HouseState.txt", true));

            String lineToWrite = String.format("Simulation Number %s, Cost: %s",simulationCount,getTotalCost());
            ps.print(lineToWrite+"\n");
            simulationCount++;
